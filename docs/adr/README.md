...
| [ADR-15](ADR-15.md) | registry, oidc, security | Quay↔Keycloak OIDC SSO: confidential client with client-secret auth (no PKCE — HOL-1257), username from the ID token, roles/groups via the `groups` claim into Quay teams |
