...
// HOL-1197 (k3d-k3d-registry.holos.localhost:5000/holos-paas).  The cluster is created
// with --registry-usek3d-registry.holos.localhost:5000, so images pushed to
//k3d-registry.holos.localhost:5000 are pullable in-cluster (docs/local-cluster.md).
