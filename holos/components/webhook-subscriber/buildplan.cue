...
// HOL-1197 (k3d-quay.holos.localhost/holos/holos-paas).  The cluster is created
// with --registry-usequay.holos.localhost/holos, so images pushed to
//quay.holos.localhost/holos are pullable in-cluster (docs/local-cluster.md).
