...
// istio-ztunnel renders the ztunnel chart: the per-node L4 proxy that forms
// the ambient mesh data plane.  The version pin and shared ambient values
// live in ../istio.cue.
userDefinedBuildPlan: {
	metadata: name: "istio-ztunnel"
