...
#PoolerSpec: {
	...
	// single
	// ServiceAccount across multiple poolers (e.g., for cloud IAM
	// configurations).
	...
	template?: {
		...
		spec?: {
			...
			resourceClaims?: [...{
				...
				//
				// When the DRAWorkloadResourceClaims feature gate is enabled and
				// the pod
				// belongs to a PodGroup that defines a PodGroupResourceClaim with
				// the same
				// Name and ResourceClaimTemplateName, this PodResourceClaim
				// resolves to the
				// ResourceClaim generated for the PodGroup. All pods in the group
				// that
				// define an equivalent PodResourceClaim matching the
				// PodGroupResourceClaim's Name and ResourceClaimTemplateName
				// share the same
				// generated ResourceClaim. ResourceClaims generated for a
				// PodGroup are
				// owned by the PodGroup and their lifecycles are tied to the
				// PodGroup
			...
			schedulingGroup?: {
				// PodGroupName specifies the name of the standalone PodGroup
				// object
