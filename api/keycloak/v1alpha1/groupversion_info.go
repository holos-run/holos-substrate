...
// the platform provisions on a project's behalf — Instance (a
// centrally-managed reference to one Keycloak target), Group,
// GroupMembership, User, and Client — as Kubernetes
...
// Instance plus a credential secretRef (see SecretReference): reaching
