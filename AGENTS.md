...
- **Reference:** `holos/components/my-project/buildplan.cue` (the emitted Organization CR + gated `spec.caBundle`), `scripts/apply-my-project` (the dedicated apply step that injects the local-ca PEM), `holos/README.md` (*The `my-project` delivery scaffold*), `holos/docs/oci-publish-workflow.md` (*Downstream: the `my-project` delivery scaffold*), `docs/adr/ADR-16.md`, `docs/adr/ADR-19.md` (the `caBundle` convention).
