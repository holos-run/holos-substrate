...
- **Reference:** `holos/components/quay/buildplan.cue` (the `ADMIN_BOOTSTRAP_*` resources and `ADMIN_BOOTSTRAP_SCRIPT`), `scripts/apply` (`pre_quay`, `wait_quay`), `scripts/quay-init`.
